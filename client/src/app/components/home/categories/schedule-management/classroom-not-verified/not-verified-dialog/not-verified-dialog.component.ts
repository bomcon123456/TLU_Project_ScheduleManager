...
@Component({
  selector: 'app-not-verified-dialog',
  templateUrl: './not-verified-dialog.component.html',
  styleUrls: ['./not-verified-dialog.component.scss']
})

export class NotVerifiedDialogComponent implements OnInit {
  ...
  constructor(private courseApi: CourseApiService,
    ...
    public dialogRef: MatDialogRef<NotVerifiedDialogComponent>,
