...
export class CalendarApiService {
  ...
  // Define API
  apiURL = `${environment.apiUrl}/calendar`;
  ...
  createCalendar(calendar): Observable<any> {

    return this.http.post(this.apiURL + '/', JSON.stringify(calendar), this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.handleError)
      )
